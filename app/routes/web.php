...
Route::get('/privacy-policy', 'PrivacyPolicyController@index')->name('Política de Privacidad');
Route::get('/terms-condition', 'TermsConditionController@index')->name('Términos y Condiciones');
