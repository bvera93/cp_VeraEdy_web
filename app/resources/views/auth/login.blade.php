...
<body class="h-100">
    ...
    <div class="login-form-bg h-100">
        <div class="container h-100">
            <div class="row-login justify-login-center h-100">
                <div class="col-xl-6">
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-login pt-5">

                                <a class="text-center" href="#"><center><img src="{!! asset('public/assets/images/logo.png') !!}" height="180" width="210" alt=""></center></a>
