...
<div class="col-md-6 col-lg-3 dataid{{$itemimage->id}}" id="table-image">
    <div class="card">
        ...
        <div class="card-body">
            <button type="button" onClick="EditDocument('{{$itemimage->id}}')" class="btn mb-2 btn-sm btn-primary">Editar</button>
            <button type="button" onclick="DeleteImage('{{$itemimage->id}}')" class="btn mb-2 btn-sm btn-danger">Eliminar</button>
        </div>
    </div>
</div>
<?php
