...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCategory" data-whatever="@addCategory">Agregar categoria</button>
        <!-- Add Category -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="category_name" class="col-form-label">Nombre de categoria:</label>
                ...
                <form method="post" name="editcategory" class="editcategory" id="editcategory" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="category_id" class="col-form-label">Nombre de categoria:</label>
                                <input type="text" class="form-control" id="getcategory_name" name="category_name" placeholder="Category Name">
                            </div>
                            <div class="form-group">
                                <label for="image" class="col-form-label">Seleccionar categoria:</label>
                                <input type="file" class="form-control" name="image" id="image" accept=".png, .jpg, .jpeg">
                            </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == 1) {
                        swal({
                            title: "'¡Aprobado!",
                            text: "Categoria ha sido eliminada.",
                            type: "success",
                            showCancelButton: true,
                            confirmButtonClass: "btn-danger",
