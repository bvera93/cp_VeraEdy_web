...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Horario</a></li>
        </ol>
    </div>
</div>
<!-- row -->
    	                ...
    	                <form action="{{ URL::to('admin/time/store') }}" method="post">
    	                	...
    	                	<div class="form-row">
    	                	    ...
    	                	    <div class="form-group col-md-3" style="text-align: center;">
    	                	        <label><strong>Abierto</strong></label>
    	                	    </div>
    	                	    <div class="form-group col-md-3" style="text-align: center;">
    	                	        <label><strong>Cerrado</strong></label>
    	                	    </div>
                                <div class="form-group col-md-3" style="text-align: center;">
                                    <label><strong>Seleccione está opción si siempre esta cerrado</strong></label>
                                </div>
    	                	</div>
    	                    ...
    	                    <div class="form-row">
                                ...
                                @if ($time->always_close == '2')
                                    <div class="form-group col-md-3">
                                        <input type="text" class="form-control" placeholder="Horas abiertas" id="open{{$time->day}}" name="open_time[]" value="{{$time->open_time}}">
                                    </div>
                                @else
                                    <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                    <select class="form-control" name="always_close[]" id="always_close{{$time->day}}">
                                        <option value="">Seleccione si está siempre cerrado</option>
                                        <option value="1" @if ($time->always_close == '1') selected @endif>Si</option>
