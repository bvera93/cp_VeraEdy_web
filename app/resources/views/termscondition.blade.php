...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Términos & Condiciones</a></li>
        </ol>
    </div>
</div>
<!-- row -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <span id="msg"></span>
                    <h4 class="card-title">Términos & Condiciones</h4>
                    ...
                    <div id="privacy-policy-three" class="privacy-policy">
                        <form name="termscondition" id="termscondition">
                            ...
                            <button type="submit" name="update" class="btn mb-1 btn-primary mt-5">Actualizar</button>
                        </form>
                    </div>
                </div>
            </div>
