...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Imagenes de productos</a></li>
        </ol>
    </div>
</div>
<!-- row -->
...
<div class="container-fluid">
    ...
    <div class="row">
                    ...
                    <div class="md-6">
                        ...
                        <div class="img-aside">
                            ...
                            <div class="img-aside-btn">
                                <button type="button" onClick="Editingredients('{{$ingredients->id}}')" class="btn mb-2 btn-sm btn-primary">Editar</button>
                                <button type="submit" onclick="Deleteingredients('{{$ingredients->id}}')" class="btn mb-2 btn-sm btn-danger">Eliminar</button>
                            </div>
                        </div>
                        <?php
                        }
        ...
        <div class="col-lg-8 col-xl-9">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#AddProduct" data-whatever="@addProduct">Agregar imagen </button>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#AddIngredients" data-whatever="@addIngredients">Agregar imagen de ingrediente</button>
            <div id="card-display">
    ...
    <div class="modal fade" id="EditIngredients" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabeledit" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form method="post" name="editingredients" class="editingredients" id="editingredients" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabeledit">Imagen de producto</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <span id="iemsg"></span>
            ...
            <form method="post" name="addproduct" class="addproduct" id="addproduct" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="colour" class="col-form-label">Seleccionar imagen:</label>
    ...
    <div class="modal fade" id="AddIngredients" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form method="post" name="addingredients" class="addingredients" id="addingredients" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Agregar imagen de ingrediente</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <span id="aiemsg"></span>
...
<script type="text/javascript">
    ...
    function DeleteImage(id) {
        ...
        function(isConfirm) {
            if (isConfirm) {
                ...
                swal("Cancelado", "Cancelación exitosa", "error");
            }
        });
    }
    ...
    function Deleteingredients(id) {
        ...
        swal({
            title: "¿Está seguro?",
            text: "¿Quieres borrar esta imagen de los ingredientes?",
            type: "warning",
            showCancelButton: true,
            confirmButtonClass: "btn-danger",
            confirmButtonText: "Si, elimínelo!",
