...
<html>
<head>
    <title>Verificación de Correo Electrónico - Samu Wings</title>
</head>
<body>
<div>
                        ...
                        <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:20px 0 0px 0">
                            ...
                            <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:15px 0 0px 0">
                                <div bgcolor="#f8f4e8" align="left"
                                    ...
                                    Su código de verificación de correo electrónico es <b style="color: #fe724c;"> {{$otp}}</b><br>Por favor verifique su correo electrónico para acceder a su cuenta.
