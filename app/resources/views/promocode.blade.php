...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Código Promocional</a></li>
        </ol>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addPromocode" data-whatever="@addPromocode">Agregar código promocional</button>
        <!-- Add Promocode -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Agregar código promocional</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="offer_name" class="col-form-label">Nombre de promoción:</label>
                            <input type="text" class="form-control" name="offer_name" id="offer_name">
                        </div>
                        <div class="form-group">
                            <label for="offer_code" class="col-form-label">Código de promoción:</label>
                            <input type="text" class="form-control" name="offer_code" id="offer_code">
                        </div>
                        <div class="form-group">
                            <label for="offer_amount" class="col-form-label">Porcentaje de promoción (%):</label>
                            <input type="text" class="form-control" name="offer_amount" id="offer_amount">
                        </div>
                        <div class="form-group">
                            <label for="description" class="col-form-label">Descripción de promoción:</label>
        ...
        <div class="modal fade" id="EditPromocode" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabeledit" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form method="post" name="editpromocode" class="editpromocode" id="editpromocode">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabeledit">Editar codigo promocional</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <span id="emsg"></span>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="getoffer_name" class="col-form-label">Nombre de promoción:</label>
                                <input type="text" class="form-control" name="getoffer_name" id="getoffer_name">
                            </div>
                            <div class="form-group">
                                <label for="getoffer_code" class="col-form-label">Código de promoción:</label>
                                <input type="text" class="form-control" name="getoffer_code" id="getoffer_code">
                            </div>
                            <div class="form-group">
                                <label for="getoffer_amount" class="col-form-label">Porcentaje de promoción (%):</label>
                                <input type="text" class="form-control" name="getoffer_amount" id="getoffer_amount">
                            </div>
                            <div class="form-group">
                                <label for="get_description" class="col-form-label">Descripción de promoción:</label>
                                <textarea class="form-control" name="get_description" id="get_description" placeholder="Descripción"></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Todos los códigos promocionales</h4>
...
function StatusUpdate(id,status) {
    swal({
        title: "¿Está seguro?",
        text: "¿Esta seguro de eliminar el código promocional?",
        type: "warning",
