...
<body>
    ...
    ********************-->
    <div id="preloader">
        <div class="loader">
            <img src="{!! asset('public/front/images/loader.gif') !!}" style="width: 120px;">
        </div>
    </div>
    <!--*******************
        Preloader end
                ...
                <div class="form-group">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <label class="modal-title text-text-bold-600" id="RditProduct">Cambiar contraseña</label>
                        ...
                        {{csrf_field()}}
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="password" placeholder="Ingrese contraseña actual" class="form-control" name="oldpassword" id="oldpassword">
                            </div>

                            <label>Nueva contraseña: </label>
                            <div class="form-group">
                                <input type="password" placeholder="Ingrese nueva contraseña" class="form-control" name="newpassword" id="newpassword">
                            </div>

                            <label>Confirmar Contraseña: </label>
                            <div class="form-group">
                                <input type="password" placeholder="Ingrese contraseña nuevamente" class="form-control" name="confirmpassword" id="confirmpassword">
                            </div>
                          ...
                          <div class="modal-footer">
                            ...
                            value="Cerrar">
                            <input type="button" onclick="changePassword()" class="btn btn-outline-primary btn-lg" value="Enviar">
                          </div>
                        </form>
                      </div>
                    </div>
                  ...
                  aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <label class="modal-title text-text-bold-600" id="RditProduct">Configuración</label>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        ...
                        {{csrf_field()}}
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                                <a href="#" class="badge badge-primary px-2" onclick="getLocation()" >
                                    Haga clic aquí para obtener su ubicación actual
                                </a>
                            </div>
                            ...
                            <label>Gasto de envio: </label>
                            <div class="form-group">
                                <input type="text" placeholder="Gasto de envio" value="{{{Auth::user()->delivery_charge}}}" class="form-control" name="delivery_charge" id="delivery_charge">
                            </div>

                            <label>Cantidad Max. Pedidos: </label>
                            <div class="form-group">
                                <input type="text" placeholder="Cantidad Max" value="{{{Auth::user()->max_order_qty}}}" class="form-control" name="max_order_qty" id="max_order_qty">
                            </div>

                            <label>Monto Min. Pedido </label>
                            <div class="form-group">
                                <input type="text" placeholder="Monto Min" value="{{{Auth::user()->min_order_amount}}}" class="form-control" name="min_order_amount" id="min_order_amount">
                            </div>

                            <label>Monto Max. Pedido: </label>
                            <div class="form-group">
                                <input type="text" placeholder="Monto Max" value="{{{Auth::user()->max_order_amount}}}" class="form-control" name="max_order_amount" id="max_order_amount">
                            </div>
                          ...
                          <div class="modal-footer">
                            <input type="reset" class="btn btn-outline-secondary btn-lg" data-dismiss="modal"
                            value="Cerrar">
                            <input type="button" class="btn btn-outline-primary btn-lg" onclick="settings()"  value="Enviar">
                          </div>
                        </form>
                      </div>
                    </div>
